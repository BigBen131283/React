...
// console.log(test, test2, test3); // test est accessible (var)
...
var userName = "Julia"; // se stocke dans l'objet global
console.log(window); // objet global
